<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#cases" data-bs-toggle="collapse" href="#">
        <span>cases</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="cases" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="/hima/cases/list.php">
            <i class="bi bi-circle"></i><span>List</span>
          </a>
        </li>
      </ul>
